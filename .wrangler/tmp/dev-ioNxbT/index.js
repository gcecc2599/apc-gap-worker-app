...
// .wrangler/tmp/bundle-Q6Icyb/checked-fetch.js
...
// .wrangler/tmp/bundle-Q6Icyb/strip-cf-connecting-ip-header.js
...
api.post("/auth/login", async (c) => {
  try {
    ...
    if (username && password) {
      return c.json({
        success: true,
        user: { id: 1, username, role: "farmer" },
        token: "dummy-token"
      });
    }
    return c.json({ success: false, message: "\uB85C\uADF8\uC778 \uC2E4\uD328" }, 401);
  } catch (error) {
...
api.get("/users/:id", async (c) => {
  ...
  return c.json({ id, username: "test", role: "farmer" });
});
    ...
    <header class="bg-white shadow-sm sticky top-0 z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div class="flex items-center justify-between">
                ...
                <a href="/" class="text-sm sm:text-base text-gray-600 hover:text-green-600 transition">\uB85C\uADF8\uC544\uC6C3</a>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div class="border-b border-gray-200 mb-4 sm:mb-6">
            <nav class="flex space-x-2 sm:space-x-4 overflow-x-auto">
                <button class="tab-btn active px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-green-600 border-b-2 border-green-600 whitespace-nowrap">
                    \uC601\uB18D\uC77C\uC9C0
                </button>
                <button class="tab-btn px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent whitespace-nowrap">
                    \uBC29\uC81C \uAE30\uB85D
                </button>
                <button class="tab-btn px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent whitespace-nowrap">
                    \uAD00\uC218 \uAE30\uB85D
        ...
        <!-- \uC601\uB18D\uC77C\uC9C0 \uD3FC -->
        <div id="daily-record-form" class="tab-content bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <form id="dailyForm" class="space-y-4 sm:space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">\uB0A0\uC9DC</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">\uB0A0\uC528</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">\uC628\uB3C4 (\xB0C)</label>
                    <input type="number" name="temperature" class="w-full px-3 py-2 sm:px-4 sm:py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">\uC791\uC5C5 \uB0B4\uC6A9</label>
        ...
        <!-- \uAE30\uD0C0 \uD0ED \uCF58\uD150\uCE20 (\uC228\uAE40) -->
        <div id="other-tabs" class="hidden">
            <div class="bg-white rounded-lg shadow p-4 sm:p-6 text-center text-gray-500">
                \uC900\uBE44 \uC911\uC785\uB2C8\uB2E4.
            </div>
        </div>
    </main>
...
__name(getFarmerDashboard, "getFarmerDashboard");
    ...
    <div class="w-full max-w-md lg:max-w-lg xl:max-w-xl mx-auto p-4 sm:p-6 md:p-8">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl p-4 sm:p-6 md:p-8">
            ...
            <div class="text-center mb-6 sm:mb-8">
                ...
                <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">\uB18D\uAC00 \uC218\uCD9C \uAE30\uB85D\uAD00\uB9AC \uC2DC\uC2A4\uD15C</h1>
            ...
            <div class="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600">
        ...
        <div class="text-center mt-4 sm:mt-6 text-white text-xs sm:text-sm">
            <p>\xA9 2026 APC. All rights reserved.</p>
        </div>
    </div>
...
__name(getMainPage, "getMainPage");
app.get("/", (c) => {
  ...
  return c.html(`
    ...
    <body class="bg-gray-100 p-4 sm:p-6 md:p-8">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">\uAD00\uB9AC\uC790 \uB300\uC2DC\uBCF4\uB4DC</h1>
            <p class="text-gray-600 text-sm sm:text-base">\uAD00\uB9AC\uC790 \uB300\uC2DC\uBCF4\uB4DC\uAC00 \uC900\uBE44 \uC911\uC785\uB2C8\uB2E4.</p>
            <a href="/" class="mt-4 inline-block text-sm sm:text-base text-blue-600 hover:text-blue-800 hover:underline transition">\u2190 \uBA54\uC778\uC73C\uB85C \uB3CC\uC544\uAC00\uAE30</a>
        </div>
    </body>
    </html>
  `);
...
// .wrangler/tmp/bundle-Q6Icyb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Q6Icyb/middleware-loader.entry.ts
